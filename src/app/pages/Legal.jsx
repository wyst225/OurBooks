              ...
              <CardContent className="prose max-w-none space-y-6 text-muted-foreground">
                <section>
                  ...
                  <p className="text-sm leading-relaxed">
                    By accessing and using Our E-books' services, you agree to be bound by these Terms of
                ...
                <section>
                  ...
                  <p className="text-sm leading-relaxed">
                    Our E-books shall not be liable for any indirect, incidental, special, or consequential
              ...
              <CardContent className="prose max-w-none space-y-6 text-muted-foreground">
                ...
                <section>
                  ...
                  <p className="text-sm leading-relaxed">
                    ...
                    rights, please contact us at privacy@ourebooks.com.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className="text-sm leading-relaxed">
                    ...
                    privacy@ourebooks.com or write to us at Our E-books Privacy Department, 123 Library
